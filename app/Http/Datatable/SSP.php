...
class SSP
{
     ...
     */
    public static function simple($request, $conn, $table, $primaryKey, $columns): array
    {
        $bindings = array();
        $db = self::db($conn);
     ...
     *
     * @param PDO|resource $db Database handler
     ...
     */
    public static function sql_exec(PDO $db, $bindings, $sql = null): array
    {
        // Argument shifting
        if ($sql === null) {
            $sql = $bindings;
     ...
     *   would be used.
     */
    protected static function bind(&$a, $val, $type)
    {
