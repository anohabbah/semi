$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', Mise.baseUrl + '/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', Mise.baseUrl + '/css/bootstrap-' + themeName + '.min.css');
        }
    ...
    if (window.tinyMCE) {
        tinymce.init({
            ...
            plugins: [
                ...
                'template paste textcolor colorpicker textpattern imagetools code toc'
            ],
            toolbar1: 'styleselect | bold italic | alignleft aligncenter | bullist numlist outdent indent | link',
            toolbar2: '',
        });
    }
